import { MessageSquare, FileText, Gift, AlertCircle, User, LogOut, Languages, Sparkles, Users, Calendar, Building2 } from 'lucide-react';
...
export function Dashboard({ userName, onNavigate, onLogout, onShowFeatures }: DashboardProps) {
  ...
  const modules: Module[] = [
    ...
    },
    {
      id: 'gram-sabha',
      title: t('gram-sabha'),
      description: t('village-meetings'),
      emoji: '👥',
      color: 'bg-cyan-500'
    }
  ];
              ...
              >
                <CardHeader>
                  <div className="flex items-start gap-4">
                    <div className={`${module.color} p-3 rounded-lg text-white flex items-center justify-center`}>
                      {module.emoji ? (
