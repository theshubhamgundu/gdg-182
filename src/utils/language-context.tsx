...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    delete: 'Delete',
    back: 'Back',
    'gram-sabha': 'Community Meetings',
    'village-meetings': 'Track local Panchayat, Ward & Municipal meetings',
  },
  hi: {
    dashboard: 'डैशबोर्ड',
    ...
    delete: 'हटाएं',
    back: 'वापस',
    'gram-sabha': 'सामुदायिक बैठकें',
    'village-meetings': 'ग्राम पंचायत, वार्ड और नगरपालिका बैठकों को ट्रैक करें',
  },
  ta: {
    ...
    loading: 'ஏற்றுகிறது...',
    back: 'பின்செல்',
    'gram-sabha': 'சமூக கூட்டங்கள்',
    'village-meetings': 'உள்ளூர் பஞ்சாயத், வார்டு மற்றும் நகராட்சி கூட்டங்களைக் கண்காணிக்கவும்',
  },
  te: {
    ...
    back: 'వెనక్కి',
    'gram-sabha': 'సామాజిక సభలు',
    'village-meetings': 'స్థానిక పంచాయతీ, వార్డ్ & మున్సిపల్ సభలను ట్రాక్ చేయండి',
  },
  bn: {
    ...
    loading: 'লোড হচ্ছে...',
    back: 'ফিরে যান',
    'gram-sabha': 'সামাজিক সভা',
    'village-meetings': 'স্থানীয় পঞ্চায়েত, ওয়ার্ড এবং পৌরসভা সভাগুলি ট্র্যাক করুন',
  },
  mr: {
    dashboard: 'डॅशबोर्ड',
    ...
    loading: 'लोड होत आहे...',
    back: 'मागे',
    'gram-sabha': 'सामाजिक बैठकी',
    'village-meetings': 'स्थानिक पंचायत, वॉर्ड आणि महापालिका बैठकींचे अनुसरण करा',
  },
};
