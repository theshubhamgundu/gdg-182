...
import { GramSabhaSummarizer } from './components/GramSabhaSummarizer';
import { LanguageProvider } from './utils/language-context';

type Screen = 'dashboard' | 'companion' | 'documents' | 'schemes' | 'complaints' | 'profile' | 'gram-sabha';
  ...
  return (
    <LanguageProvider>
      <div className="relative">
        ...
        {currentScreen === 'gram-sabha' && (
          <GramSabhaSummarizer accessToken={accessToken} onBack={handleBack} />
        )}
